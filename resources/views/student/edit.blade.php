@extends('layouts.app')
@section('title', trans('lang.edit_student'))
@section('content')



<h3 class="mb-5 mt-5 text-primary text-center ">{{trans('lang.edit_student')}}</h3>
        ...
        <div class="card-body text-primary ">
            ...
            <form method="post">
                ...
                <div class="mt-2 card-footer bg-transparent border-info d-flex justify-content-between ">
                    ...
                    <button type="submit" class="btn btn-success text-white">{{trans('lang.save')}}</button>
